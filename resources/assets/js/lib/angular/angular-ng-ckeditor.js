...
(function (angular, factory) {
    if (typeof define === 'function' && define.amd) {
        define(['resources/assets/js/lib/angular/angular', 'ckeditor'], function (angular) {
        ...
        return {
            ...
            link: function (scope, element, attrs, ctrls) {
                ...
                var onLoad = function () {
                    ...
                    var instance = (isTextarea) ? CKEDITOR.replace(element[0]) : CKEDITOR.inline(element[0]),
                    ...
                    var setModelData = function (setPristine) {
	                    readOnly = typeof attrs.readOnly == 'undefined' ? false : scope.$eval(attrs.readOnly) ;
