	...
	<div class="container">
		<nav class="menu">
			<ul class="menu-list">
				...
				@if(Auth::user())
				<li class="enter" id="showAccountLink">
	...
	<div class="container">
		...
		<div class="header-grid">
			...
			<div class="header-inner">
				...
				<div class="callback">
					<?php $phones = isset($data['phones']) ? json_encode($data['phones']) : '000-00-00' ?>
					<callback :phones="{{ $phones }}" />
				</div>
